                        ...
                        <div className="space-y-4">
                            <details className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 group">
                                ...
                                <div className="mt-4 text-gray-600 leading-relaxed">
                                    Sim, temos vasta experiência com o setor têxtil, focando na prevenção de doenças profissionais relacionadas com esforços repetitivos, poeiras e ruído, garantindo a saúde dos seus operários.
                                </div>
                            </details>
