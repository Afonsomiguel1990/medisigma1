...
export const metadata: Metadata = {
  title: 'Segurança Contra Incêndios (SCIE) | Medidas e Extintores',
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white flex flex-col divide-y divide-border">
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
                  Acompanhamos as necessidades de segurança contra incêndios do edifício, desde a avaliação do enquadramento à organização das medidas e registos.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  O projeto e as medidas de autoproteção dependem da utilização-tipo, da categoria de risco e das características do edifício. O âmbito deve ser definido com o responsável de segurança e os técnicos intervenientes.
                </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-lg border border-border">
                    ...
                    <p className="text-muted-foreground text-sm">Verificação do estado do extintor e manutenção segundo o enquadramento e as instruções aplicáveis.</p>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-lg border border-border">
                    <div className="w-12 h-12 bg-secondary/10 rounded-lg flex items-center justify-center mb-4">
            ...
            <div className="space-y-6">
              <details className="bg-white p-6 rounded-lg shadow-sm border border-border">
                ...
                <p className="mt-4 text-muted-foreground">
                  São medidas de organização e gestão da segurança, ajustadas ao edifício, que incluem os procedimentos e registos aplicáveis à prevenção e resposta a emergências.
                </p>
              </details>
              <details className="bg-white p-6 rounded-lg shadow-sm border border-border">
                <summary className="font-semibold text-primary cursor-pointer text-lg">
                ...
                <p className="mt-4 text-muted-foreground">
                  A manutenção deve seguir a norma aplicável e as instruções do fabricante. Confirme o calendário dos equipamentos e mantenha os relatórios das intervenções disponíveis.
                </p>
              </details>
              <details className="bg-white p-6 rounded-lg shadow-sm border border-border">
                <summary className="font-semibold text-primary cursor-pointer text-lg">
        ...
        {/* CTA Section */}
        <ServiceMediaSection id="herdade-amarela" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6">
                  Proteja o Seu Espaço contra Incêndios
                </h2>
                ...
                <div className="space-y-4 mb-8 text-blue-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Conformidade com toda a legislação</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-white" />
                    <span>Planos de emergência personalizados</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-white" />
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <ContactLink href="tel:241331504" type="phone" pagina="Serviço Segurança Contra Incêndios" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                    241 331 504
                  </ContactLink>
                </div>
              </div>
