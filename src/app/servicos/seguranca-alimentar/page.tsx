            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <ContactLink href="tel:241331504" type="phone" pagina="Serviço Segurança Alimentar" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                    241 331 504
                  </ContactLink>
                </div>
              </div>
