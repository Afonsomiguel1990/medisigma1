...
imagem_destaque: 'https://images.unsplash.com/photo-1593642632823-8f78536788c6?q=80&w=2070&auto=format&fit=crop'
---
...
## Quem Paga a Luz e a Net? {#compensacao-despesas}

Esta é a dúvida #1 de gestores e trabalhadores. A lei obriga o empregador a compensar integralmente as despesas **adicionais** que o trabalhador suporte.

Segundo dados da ACT, a média de compensação mensal em 2025 ronda os **€45,30 por trabalhador**.
...
| Obrigação Legal | Regime Presencial | Regime Teletrabalho |
| :--- | :--- | :--- |
| **Acidente de Trabalho** | No local da empresa ou trajeto. | No local de residência, durante o horário definido. |
| **Equipamentos** | Fornecidos pela empresa. | Fornecidos pela empresa ou compensados se do trabalhador. |
| **Subsídio de Refeição** | Devido (salvo acordo em contrário). | Devido em igualdade de circunstâncias. |
| **Pausas e Descanso** | Controladas visualmente/ponto. | Mesmos direitos, controlo via registo digital. |
| **Despesas Adicionais** | Assumidas pela empresa (instalações). | Compensação fixa ou mediante faturas (média ~45€/mês). |
