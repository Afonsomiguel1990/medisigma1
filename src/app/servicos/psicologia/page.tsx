...
export const metadata: Metadata = {
  title: 'Psicologia e Bem-Estar no Trabalho',
              ...
              <div className="text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <ContactLink type="whatsapp"
                    href={`https://wa.me/${siteConfig.links.whatsapp}?text=Olá%2C%20estava%20no%20vosso%20website%20e%20gostaria%20de%20ter%20mais%20informações%20sobre%20Psicologia%20no%20Trabalho.`}
                    target="_blank"
                  ...
                  <ContactLink href="tel:241331504" type="phone" pagina="Serviço Psicologia" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                    241 331 504
                  </ContactLink>
                </div>
              </div>
