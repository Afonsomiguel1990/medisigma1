...
export const metadata: Metadata = {
  title: "Segurança no Trabalho | Prevenção de Acidentes e Avaliação de Riscos",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white flex flex-col divide-y divide-border">
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                O serviço parte da atividade, dos postos e dos riscos da empresa. No enquadramento da Lei n.º 102/2009, o trabalho pode incluir:
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="group bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-border hover:border-secondary/20">
                ...
                <p className="text-gray-600 text-sm">
                  Organizamos as medidas de prevenção com prioridades, responsáveis e acompanhamento das ações.
                </p>
              </div>
          ...
          <div className="container mx-auto px-6 md:px-8 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                A avaliação dos postos pode identificar a necessidade de medições ou estudos específicos. O âmbito é definido em função dos riscos encontrados.
              </p>
            </div>
        ...
        <ServiceMediaSection id="sofalca-ruido" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <ContactLink href="tel:241331504" type="phone" pagina="Serviço Segurança no Trabalho" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                    241 331 504
                  </ContactLink>
                </div>
              </div>
