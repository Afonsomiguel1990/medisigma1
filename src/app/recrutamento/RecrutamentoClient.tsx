...
import { Users, TrendingUp, Shield, Heart, Clock, GraduationCap } from 'lucide-react';
import SpontaneousApplicationForm from '@/components/SpontaneousApplicationForm';
import JobsList, { Job } from './JobsList';

export default function RecrutamentoClient({ jobs }: { jobs: Job[] }) {
        ...
        <div className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <Button variant="outline" size="lg" onClick={() => handleApplyClick('')}>
            ...
            <section id="oportunidades" className="py-16 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <JobsList initialJobs={jobs} onApplyClick={handleApplyClick} />
                    </div>
                </div>
            </section>
            ...
            <section id="candidatura" className="py-16 relative z-10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
                    <h3 className="text-2xl font-semibold mb-6 text-center">Candidatura</h3>
                    <div className="relative z-10">
                        <SpontaneousApplicationForm jobs={jobs} preSelectedJobId={selectedJobId} />
                    </div>
                </div>
            </section>
        </div>
