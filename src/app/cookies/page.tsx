  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose dark:prose-invert max-w-none text-justify">
        ...
        <p>A Medisigma (&quot;nós&quot;, &quot;nosso&quot;) utiliza cookies no nosso website (<a href="https://www.medisigma.pt">https://www.medisigma.pt</a>). Ao utilizar o nosso website, concorda com o uso de cookies em conformidade com esta Política de Cookies.</p>
