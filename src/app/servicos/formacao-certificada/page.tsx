...
export const metadata: Metadata = {
  title: 'Formação Certificada DGERT | Cursos de Segurança e Saúde',
  description: 'Formação para empresas em segurança no trabalho, saúde e proteção de pessoas e bens. Programas, duração e documentação definidos na proposta.',
          ...
          <div className="container mx-auto px-6 md:px-8 max-w-6xl">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                A formação pode ser organizada em três áreas ligadas à saúde e à segurança, articulando-se com serviços como a <Link href="/servicos/seguranca-no-trabalho" className="text-secondary font-semibold hover:underline">Segurança no Trabalho</Link> e a <Link href="/servicos/seguranca-alimentar" className="text-secondary font-semibold hover:underline">Segurança Alimentar</Link>. O programa e a documentação emitida devem corresponder ao âmbito contratado.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                { icon: Shield, area: "862", title: "Segurança e Higiene", description: "Formação sobre riscos profissionais, medidas de prevenção e procedimentos de trabalho." },
              ].map((area) => {
              ...
              <div className="text-white">
                ...
                <div className="space-y-4 mb-8 text-blue-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Programa e documentação definidos na proposta</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-white" />
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <ContactLink type="whatsapp"
                    href={`https://wa.me/${siteConfig.links.whatsapp}?text=Olá%2C%20estava%20no%20vosso%20website%20e%20gostaria%20de%20ter%20mais%20informações%20sobre%20Formação%20Certificada.`}
                    target="_blank"
                  ...
                  <ContactLink href="tel:241331504" type="phone" pagina="Serviço Formação Certificada" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                    241 331 504
                  </ContactLink>
                </div>
              </div>
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="space-y-6">
              <details className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <summary className="font-semibold text-gray-900 cursor-pointer text-lg">Como confirmar a certificação da entidade formadora?</summary>
                <p className="mt-4 text-gray-600">Confirme a entidade que realiza a formação e o respetivo âmbito no diretório da DGERT. A proposta deve identificar o programa, a duração e a documentação a emitir.</p>
              </details>
              <details className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
