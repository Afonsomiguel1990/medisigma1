...
export const metadata: Metadata = {
    title: 'Manutenção de Extintores | Certificação NP 4413',
    description: 'Manutenção de extintores, verificação do estado dos equipamentos e registo das intervenções. Peça uma proposta para as suas instalações.',
    ...
    openGraph: {
        ...
        description: 'Manutenção de extintores e acompanhamento das necessidades identificadas nas instalações.',
        type: 'website',
        locale: 'pt_PT',
    },
    alternates: {
...
const jsonLd = {
    ...
    'description': 'Serviço de manutenção preventiva e corretiva de extintores de incêndio, com registo das intervenções.',
};
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-white flex flex-col divide-y divide-border">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                            <div>
                                ...
                                <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
                                    Verificamos o estado dos extintores e identificamos as intervenções necessárias. O acompanhamento inclui registos para a gestão dos equipamentos.
                                </p>
                            ...
                            <div>
                                ...
                                <div className="bg-accent/50 p-6 rounded-xl border border-secondary/20">
                                    ...
                                    <p className="text-sm text-muted-foreground mb-4">
                                        A <strong>Medisigma</strong> é uma empresa especializada, com instalações técnicas equipadas para a execução do Serviço de Manutenção de Extintores segundo a <strong>NP 4413:2019</strong>. O âmbito técnico e a certificação aplicáveis ao prestador devem ser confirmados na proposta.
                                    </p>
                                    <p className="text-sm text-muted-foreground">
                                        Confirme os equipamentos abrangidos, as intervenções previstas, os relatórios a entregar e as situações que exigem substituição ou avaliação adicional.
                                    </p>
                                </div>
                ...
                {/* CTA Section */}
        <ServiceMediaSection id="extintores" />
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="text-white">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <ContactLink href="tel:241331504" type="phone" pagina="Serviço Manutenção Extintores" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-secondary transition-colors text-center">
                                        241 331 504
                                    </ContactLink>
                                </div>
                            </div>
