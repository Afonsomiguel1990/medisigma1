...
export const metadata: Metadata = {
    title: "Medicina e Segurança no Trabalho na Covilhã",
    description: "Serviços de SST e Medicina no Trabalho na Covilhã e Cova da Beira. Apoio à indústria têxtil, comércio e turismo da Serra da Estrela.",
    keywords: "medicina no trabalho covilha, segurança no trabalho covilha, exames médicos cova da beira, segurança contra incendios covilha, formação covilha",
    openGraph: {
        title: "Medicina e Segurança no Trabalho na Covilhã | Grupo Medisigma",
...
const services = [
    ...
    },
    {
        ...
        description: "Prevenção de acidentes e controlo de riscos profissionais para proteger os seus colaboradores em Covilhã.",
        icon: Shield,
...
export default function CovilhaPage() {
    return (
        <>
            <script
            ...
            <main className="min-h-screen bg-white flex flex-col">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-6">
                                    <div className="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-sm font-medium flex items-center">
                                        <MapPin className="w-4 h-4 mr-1" /> Covilhã
                                    </div>
                                    <span className="text-gray-500 text-sm">Serviços Locais</span>
                                </div>

                                <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                                    Segurança no Trabalho na <span className="text-secondary">Covilhã</span> e Cova da Beira
                                </h1>

                                <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                                    Apoio especializado à indústria, universidade e turismo da região.
                                    Unidades móveis disponíveis para exames médicos na sua empresa, sem deslocações.
                                </p>
                            ...
                            <div className="relative">
                                <div className="aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl relative">
                                    <Image
                                        ...
                                        alt="Segurança no trabalho na Covilhã"
                                        fill
                                        className="object-cover"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                                    <div className="absolute bottom-6 left-6 text-white">
                                        <p className="font-bold text-lg">Parceiro da Indústria Local</p>
                                        <p className="text-sm opacity-90">Covilhã, Fundão, Belmonte</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto px-6 md:px-8 max-w-7xl">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Serviços Adaptados à Região</h2>
                            <p className="text-gray-600 text-lg">
                                Conhecemos os desafios do tecido empresarial da Covilhã e oferecemos soluções à medida.
                            </p>
                        </div>
                                ...
                                <Link key={index} href={service.href} className="group">
                                    <Card className="h-full border-transparent shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden bg-white">
                                        <CardContent className="p-8">
                                            <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center text-secondary mb-6 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                    Soluções para a Indústria e Turismo de Montanha
                                </h2>
                                <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                                    A Covilhã une a tradição industrial têxtil à inovação universitária e ao turismo da Serra da Estrela.
                                    O Grupo Medisigma está preparado para apoiar todos estes setores com rigor e proximidade.
                                </p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 mb-1">Indústria Têxtil e Manufatura</h4>
                                            <p className="text-sm text-gray-600">Medicina do trabalho focada em riscos ergonómicos e ruído ocupacional.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 mb-1">Hotelaria e Turismo</h4>
                                            <p className="text-sm text-gray-600">Planos de autoproteção (SCIE) e segurança alimentar rigorosa para hotéis.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden shadow-2xl">
                                <Image
                                    ...
                                    alt="Formação profissional na Covilhã"
                                    fill
                                    className="object-cover"
                                />
                ...
                {/* CTA Section */}
                <LocationServiceMedia location="covilha" />
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                            <div className="text-white">
                                <h2 className="text-3xl md:text-5xl font-bold mb-6">
                                    Sua Empresa na Covilhã Merece o Melhor
                                </h2>
                                <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                                    Garanta a segurança dos seus trabalhadores e a conformidade legal do seu negócio.
                                    Peça já uma proposta adaptada à sua dimensão.
                                </p>
                                ...
                                <div className="p-6 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20">
                                    <h4 className="font-semibold mb-2">Cobertura Regional</h4>
                                    <p className="text-sm text-blue-100">
                                        Covilhã, Fundão, Belmonte, Castelo Branco, Guarda e toda a Cova da Beira.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="lg:w-full">
                                <ContactForm
                                    acceptMediaIntent
                                    pagina="Página Covilhã"
                                    fonte="Landing Page Covilhã"
                        ...
                        <div className="space-y-4">
                            <details className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 group">
                                <summary className="font-semibold text-lg text-gray-900 cursor-pointer flex justify-between items-center">
                                    <span>Trabalham com empresas da indústria têxtil?</span>
                                    <span className="text-secondary group-open:rotate-180 transition-transform">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6" /></svg>
                                    </span>
                                </summary>
                                <div className="mt-4 text-gray-600 leading-relaxed">
                                    Sim, temos vasta experiência com o setor têxtil, focando na prevenção de doenças profissionais relacionadas com esforços repetitivos, poeiras e ruído, com medidas ajustadas aos riscos dos postos de trabalho.
                                </div>
                            </details>

                            <details className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 group">
                                <summary className="font-semibold text-lg text-gray-900 cursor-pointer flex justify-between items-center">
                                    <span>A unidade móvel vai até à Serra da Estrela?</span>
                                    <span className="text-secondary group-open:rotate-180 transition-transform">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6" /></svg>
                                    </span>
                                </summary>
                                <div className="mt-4 text-gray-600 leading-relaxed">
                                    Sim, a nossa frota desloca-se a hotéis e estabelecimentos em toda a região da Covilhã e Serra da Estrela, facilitando o cumprimento dos exames médicos obrigatórios.
                                </div>
                            </details>
                        </div>
                    </div>
